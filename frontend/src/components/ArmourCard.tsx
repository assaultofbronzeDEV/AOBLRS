...
const styles = StyleSheet.create({
  card: { borderWidth: 2, padding: 10, gap: 7, flex: 1, minWidth: 0 },
  ...
  unit: { fontSize: 12 },
  reduction: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", gap: 6 },
  reductionLabel: { fontSize: 10, letterSpacing: 0.5, flexShrink: 1, textAlign: "right" },
